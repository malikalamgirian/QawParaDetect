 ...
 * @author wasif
 */
public class NonMonotoneAlignerOld02 {

    public NonMonotoneAlignerOld02(Properties properties) throws Exception {
        /*
...
//            nonMonotoneAlignerBase.appendChild(lexemesString2Element);
    ...
    private void addTokenBasedAlignedLexemes(Document doc,
        ...
        try {
            ...
            /*
             * Insert Semantic Similarity Loop here...
             */
...
//            /*
//             * Initialize BOW_Alignment_Table
//             */
//            String1_To_String2_BOW_Alignment_Table = new int[lexemesString1.length][lexemesString2.length];
//
//            /*
...
//                     * tokenForString1Lexeme and tokenForString2Lexeme, are equal
//                     *
//                     * and BOW_Alignment_Table[i][j] is zero... Means an alignment has not been done.
//                     *
//                     * Set the jth column to 1, for all i's, means that string2 lexeme has been aligned it to...
//                     *
//                     * OR
//                     *
//                     * If tokenForString1Lexeme and tokenForString2Lexeme, are Synonyms
//                     *
//                     * and BOW_Alignment_Table[i][j] is zero... Means an alignment has not been done.
//                     *
//                     * Set the jth column to 1, for all i's, means that string2 lexeme has been aligned it to...
...
//             * Initialize BOW_Alignment_Table
//             */
//            BOW_Alignment_Table = new int[lexemesString1.length][lexemesString2.length];
//
//
//
//            /*
...
//                     * Check If
//                     *
//                     * tokenForString1Lexeme and tokenForString2Lexeme, and
//                     * firstTwoCharactersOfPosOfString1Lexeme firstTwoCharactersOfPosOfString2Lexeme, are equal, and
//                     *
//                     * and BOW_Alignment_Table[i][j] is zero... Means an alignment has not been done,
//                     *
//                     * Set the jth column to 1, for all i's, means that string2 lexeme has been aligned it
//                     *
//                     * OR
//                     *
//                     * tokenForString1Lexeme and tokenForString2Lexeme, are Synonyms, and
//                     * firstTwoCharactersOfPosOfString1Lexeme firstTwoCharactersOfPosOfString2Lexeme, are equal, and
//                     *
//                     * and BOW_Alignment_Table[i][j] is zero... Means an alignment has not been done,
//                     *
...
//
//                        /*
//                         * Break Inner Loop, alignment done.
//                         */
//                        break;
//
