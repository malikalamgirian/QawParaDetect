...
public class FileSystemManager {
    ...
    public static BufferedReader readFile(String file_Path_Name_To_Read) throws Exception {
        /*
         * Local Declarations
         */
        ...
        try {
            /*
             * Get the object of FileInputStream
             */
            fInStream = new FileInputStream(file_Path_Name_To_Read);
            ...
            /*
             * Get the object of BufferedReader
             */
            bReader = new BufferedReader(new InputStreamReader(dInStream));

            if(bReader == null) {
                throw new Exception("readFile : file reading has failed.");
            }

        } catch (Exception e) {
            throw new Exception("FileSystemManager : readFile : "
                    + e + " : " + e.getMessage());
        }
        return bReader;
    }
