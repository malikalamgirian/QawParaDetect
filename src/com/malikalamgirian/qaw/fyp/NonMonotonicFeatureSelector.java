...
public class NonMonotonicFeatureSelector {
    ...
    private void process() throws Exception {
        ...
        String  TBALBased_CosineSimilarity_String,
                ...
                LBALEventDetection_String,
                Polarity_String,
                VerbAntonymMatch_String,
                AdjectiveAntonymMatch_String,
                NounAntonymMatch_String,
                AdverbAntonymMatch_String,
...
//                IntraString1AndIntraString2AntonymMatch_NodeList,
        ...
        try {
             ...
             */
            bWriter_For_Features_Vector_File = FileSystemManager.createFile(getNon_Monotonic_Features_Selected_File_URL());
...
//            Antonym Related
//            VerbAntonymMatch_NodeList = root.getElementsByTagName("VerbAntonymMatch");
//            AdjectiveAntonymMatch_NodeList = root.getElementsByTagName("AdjectiveAntonymMatch");
//            NounAntonymMatch_NodeList = root.getElementsByTagName("NounAntonymMatch");
//            AdverbAntonymMatch_NodeList = root.getElementsByTagName("AdverbAntonymMatch");
...
//            LBALEventDetection
            LBALEventDetection_NodeList = root.getElementsByTagName("LBALEventDetection");
...
//            OverlapCoefficient_NodeList = root.getElementsByTagName("OverlapCoefficient");
//            DiceSimilarity_NodeList = root.getElementsByTagName("DiceSimilarity");
//
//            CosineSimilarity_Without_POS_NodeList = root.getElementsByTagName("CosineSimilarityWithoutPOS");
//            OverlapCoefficient_Without_POS_NodeList = root.getElementsByTagName("OverlapCoefficientWithoutPOS");
//            DiceSimilarity_Without_POS_NodeList = root.getElementsByTagName("DiceSimilarityWithoutPOS");
...
//                LBALBased_OverlapCoefficient_String = LBALBased_OverlapCoefficient_NodeList.item(i).getTextContent();
                ...
                /*
                 * LBALEventDetection String select
                 */
                LBALEventDetection_String = LBALEventDetection_NodeList.item(i).getTextContent();
...
//                LBALSequenceForString2BasedEventDetection_String = LBALSequenceForString2BasedEventDetection_NodeList.item(i).getTextContent();
                 ...
                 */
//                VerbAntonymMatch_String = VerbAntonymMatch_NodeList.item(i).getTextContent();
//                AdjectiveAntonymMatch_String = AdjectiveAntonymMatch_NodeList.item(i).getTextContent();
//                NounAntonymMatch_String = NounAntonymMatch_NodeList.item(i).getTextContent();
//                AdverbAntonymMatch_String = AdverbAntonymMatch_NodeList.item(i).getTextContent();
...
//                line_To_Insert_In_File = appendString(line_To_Insert_In_File, LBALBased_OverlapCoefficient_String, feature_Separator_Char);
                 ...
                 * LBALEventDetection
                 */
                line_To_Insert_In_File = appendString(line_To_Insert_In_File, LBALEventDetection_String, feature_Separator_Char);
...
//                 */
//                line_To_Insert_In_File = appendString(line_To_Insert_In_File, VerbAntonymMatch_String, feature_Separator_Char);
//                line_To_Insert_In_File = appendString(line_To_Insert_In_File, AdjectiveAntonymMatch_String, feature_Separator_Char);
//                line_To_Insert_In_File = appendString(line_To_Insert_In_File, NounAntonymMatch_String, feature_Separator_Char);
//                line_To_Insert_In_File = appendString(line_To_Insert_In_File, AdverbAntonymMatch_String, feature_Separator_Char);
...
//                line_To_Insert_In_File = appendString(line_To_Insert_In_File, OverlapCoefficient_Without_POS_String, feature_Separator_Char);
    ...
    private void setNon_Monotonic_Features_Selected_File_URL(Properties properties) throws Exception {
        ...
        try {
             ...
             */
            suffixToAdd = "_non_monotonic_selected_complete";
