 ...
 * @author wasif
 */
public class NonMonotoneAlignerOld01 {

    public NonMonotoneAlignerOld01(Properties properties) throws Exception {
        /*
        ...
        try {
            ...
            for (int i = 0; i < lexemesString1.length; i++) {
                ...
                for (int j = 0; j < lexemesString2.length; j++) {
                     ...
                     */
                    if (tokenForString1Lexeme.equalsIgnoreCase(tokenForString2Lexeme) && BOW_Alignment_Table[i][j] == 0) {
                        /*
